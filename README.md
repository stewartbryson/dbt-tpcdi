...
1. A CLI developed using [Python Snowpark](https://docs.snowflake.com/en/developer-guide/snowpark/python/index) and [Typer](https://typer.tiangolo.com/). This CLI creates tables in Snowflake for the files generated by the [TPC-DI](https://www.tpc.org/tpcdi/) benchmark specification.
2. A dbt project for building the data warehouse defined in the TPC-DI specification.
